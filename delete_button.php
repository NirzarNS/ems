...
<form  name="myform" method="post"  action="deletecopy.php">
<?php
...
<!--http://phppot.com/php/updatedelete-multiple-rows-using-php/ -->
 ...
 <table>
  <tr>
    <td align="center"><font size="7"><b>Delete Equipment</b></font></td>
  </tr>
  <tr>
    <td>	
 <div class="container">	
...
for($i=0;$i<$trows;$i++)
 ...
 if($storeArray[$i][11]=="WRITEOFF")            			
			  { ?>
		 <tr bgcolor="crimson"><td><input type="checkbox" name="items[]" value="<?php echo $storeArray[$i][0]; ?>" ></td>
		 ...
		 <td><?php echo $storeArray[$i][9] ?></td><td><?php echo $storeArray[$i][10]?></td><td><?php echo $storeArray[$i][11]?></td>
		 <td><?php echo $storeArray[$i][1] ?></td><td><?php echo $storeArray[$i][12]?></td></tr>
			  <?php }
			 
			  
			 else if(preg_match("/Transferred/i",$storeArray[$i][11])) { ?>
			  <tr bgcolor="Yellow"><td><input type="checkbox" name="items[]" value="<?php echo $storeArray[$i][0]; ?>" ></td>
			  <td><?php echo $storeArray[$i][0]?></td><td><?php echo $storeArray[$i][2]?></td>
		 <td><?php echo $storeArray[$i][3] ?></td><td><?php echo $storeArray[$i][4]?></td><td><?php echo $storeArray[$i][5] ?></td>
		 <td><?php echo $storeArray[$i][6]?></td><td><?php echo $storeArray[$i][7]?></td><td><?php echo $storeArray[$i][8]?></td>
		 <td><?php echo $storeArray[$i][9] ?></td><td><?php echo $storeArray[$i][10]?></td><td><?php echo $storeArray[$i][11]?></td>
		 <td><?php echo $storeArray[$i][1] ?></td><td><?php echo $storeArray[$i][12]?></td></tr>
			  ...
			  { ?>
			  <tr><td><input type="checkbox" name="items[]" value="<?php echo $storeArray[$i][0]; ?>" ></td>
			  <td><?php echo $storeArray[$i][0]?></td><td><?php echo $storeArray[$i][2]?></td>
		 <td><?php echo $storeArray[$i][3] ?></td><td><?php echo $storeArray[$i][4]?></td><td><?php echo $storeArray[$i][5] ?></td>
		 <td><?php echo $storeArray[$i][6]?></td><td><?php echo $storeArray[$i][7]?></td><td><?php echo $storeArray[$i][8]?></td>
		 <td><?php echo $storeArray[$i][9] ?></td><td><?php echo $storeArray[$i][10]?></td><td><?php echo $storeArray[$i][11]?></td>
...
<br/>
<table border="3" cellspacing="1" cellpadding="2" color="black" align="center" width="300">
<tr>
<td width="10%"><input type="checkbox" id="selectall" onClick="selectAll(this)" />
			</td>
			<td width="75%"><?php echo "check or uncheck all"; ?></td>
			</tr>
</table>
<table align="center">
<tr>
<td></td>
<td><input type="Submit" value="Delete" name="Delete"  onclick="return confirm('Are you sure to delete the items?')"></td>
</tr>
</table>
<?php
mysql_close($con);
